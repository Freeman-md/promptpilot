      ...
      <div className="border-t border-gray-200 bg-white p-4">
        <form className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
          />
          <button
            type="submit"
            className="p-2 rounded-lg bg-[var(--color-primary)] text-white hover:opacity-90 transition"
          >
            <IconSend size={18} />
          </button>
        </form>
